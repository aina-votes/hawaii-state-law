...
| 5 | **HAR** (administrative rules) | within the agency's grant | LRB 2025 Table & Directory (authoritative); ltgov index omits 4 titles | **yes, completely** — 24 titles / 1,595 chapters / 42,002 typed HRS→HAR edges + per-title source URLs and size estimates (2026-07-25) | **480 chapters / 9,953 sections (2026-07-26, [[src-2026-07-26-har-text-at-scale]])** — everything posted online with a text layer. Remaining gaps: 243 scanned docs (OCR tail, worst in Health), title 20 fetch-blocked, 14 quarantined layouts, 99 excerpt-only postings, titles 1/9/22 not published online |
